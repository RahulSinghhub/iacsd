...
Synchronization = Applying thread safety or applying locks , to guard a critical section
...
synchronized(shared resource reference to be locked , eg : JointAccount ref)
{ 
